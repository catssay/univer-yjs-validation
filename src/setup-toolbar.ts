...
import { setupClearStyles, setupCollaboration, setupCommandsListenerSwitch, setupCreateSheet, setupEditSwitch, setupGetA1CellData, setupGetSheetData, setupGetValue, setupGetWorkbookData, setupRedo, setupScrollToBottom, setupScrollToCell, setupScrollToTop, setupSetBackground, setupSetSelection, setupSetValue, setupSetValues, setupUndo } from './api'
...
export function setupToolbar(univerAPI: FUniver) {
  ...
  setupCollaboration($toolbar, univerAPI)
}
